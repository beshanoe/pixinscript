/* !!!!!!!!!!!!!!! IMPORTANT !!!!!!!!!!!!!!
This is a fork of the TypeScript lib.es5.d.ts file with the following changes:
Renamed Parameters type to Arguments because PixInsight has a global object named Parameters that conflicts with the type name.
*/
